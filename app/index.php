...
<body>
    ...
    <div class="mt-5">
        <div class="tab-content mt-2">
            ...
            <?php
            include 'component/dashboard.php';
            include 'component/pembelian.php';
            include 'component/kategori.php';
            include 'component/bahanbaku.php';
            include 'component/supplier.php';
            ?>
